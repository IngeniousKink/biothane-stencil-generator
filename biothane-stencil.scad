...
stencil_length,
    ...
    include_back_pane,
    front_left_cutout,
    front_left_cutout_offset_side,
    front_left_cutout_offset_end,
    front_right_cutout,
    front_right_cutout_offset_side,
    front_right_cutout_offset_end,
    back_left_cutout,
    back_left_cutout_offset_side,
    back_left_cutout_offset_end,
    back_right_cutout,
    back_right_cutout_offset_side,
    back_right_cutout_offset_end,
    marker_width,
    marker_short_mark_length,
    extra_width)
{
